...
// declare initial values for sensors
...
// declare delay time in ms for main loop
int periodicity = 100;
...
void loop() {
  ...
  float temperature = (temperatureSensor*4.88)/10
  ...
  //  turn correct LED on and turn others off 
